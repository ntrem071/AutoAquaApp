...
int EC_int;   
const int pump = 9;  // First pump
const int pump2 = 10; // Second pump
String input;
...
void pumpEvent(String input){
    
  String str1 = "ON";
  String str2 = "OFF";

  Serial.println(input);
  Serial.println(input.indexOf(str1) != -1);

  if (input.indexOf("1") != -1) {
    if(inputstring.indexOf(str1) != -1){
      digitalWrite(pump,HIGH);
      Serial.println(inputstring);
    }else if(inputstring.indexOf(str2) != -1){
